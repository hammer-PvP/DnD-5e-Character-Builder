...
export const SPELL_PREPARATION_CADENCE_BY_CLASS = Object.freeze({
  bard: SPELL_PREPARATION_CADENCES.levelUp,
...
export const UNPREPARED_SPELL_USAGE_MODES = Object.freeze({
  off: "off",
...
export function defaultSettings() {
  return {
    ...
    playerSheetIntegrityConfig: {
      ...
      // New usage restrictions are opt-in so updating an existing protected
      // world never changes normal spell usage until the GM chooses a mode.
      unpreparedSpellUsage: UNPREPARED_SPELL_USAGE_MODES.off
    },
