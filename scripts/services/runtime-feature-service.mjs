...
export class RuntimeFeatureService {
  static async actions(actor, restType, registry, session = null) {
    ...
    rows.push(...LongRestSpellPreparationService.actions(actor, type, session));
  ...
  static async actionContext(actor, action, registry, session = null) {
    ...
    if (LongRestSpellPreparationService.isActionId(action?.id)) {
      return LongRestSpellPreparationService.context(actor, action, operation);
    }
    switch (action.kind) {
  ...
  static async applyOperation(actor, registry, actionId, payload, transactionId, session = null) {
    ...
    if (LongRestSpellPreparationService.isActionId(actionId)) {
      return LongRestSpellPreparationService.applyOperation(actor, actionId, payload, transactionId);
    }
    switch (actionId) {
