...
Supported Ability Score methods include Point Buy, Standard Array, GM-defined Custom Array, rolled sets, and optional Manual entry. Standard, Custom, and rolled arrays show where each occupied value is currently assigned; selecting that value on another Ability moves it and clears the previous Ability rather than silently swapping scores.
