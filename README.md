...
A complete description of every setting, its default, scope, dependencies, and Actor impact is included in [the complete manual](docs/Character-Builder-Manual.md#settings-reference).
...
See the [complete manual](docs/Character-Builder-Manual.md#compatibility-and-conflict-reports) for compatibility notes and the conflict-report checklist.
